...
<Update label="August 2026" tags={["Removals", "Breaking changes"]} rss={{ title: "Workspace Scope, Public Agent Workspaces, and Public Chat Modes Removed", description: "Workspaces are per-conversation only, and the public agent is always Chat" }}>
