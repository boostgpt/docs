...
<Update label="May 2026" tags={["New releases", "Improvements"]} rss={{ title: "CRM, Pipeline, Reminders, and Tool Access Controls", description: "Capture leads, manage deals, follow up with reminders, and control public vs staff connector tools" }}>
