...
<Update label="February 2026" tags={["New releases"]} rss={{ title: "21 Built-in Agent Tools", description: "Complete toolkit for autonomous agents — knowledge search, user memory, file operations, planning, communication, and automation" }}>

  ## Built-in agent tools

  Agents in `agent` reasoning mode now have access to **21 built-in tools** across 7 categories — no configuration required:
