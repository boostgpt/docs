...
<Update label="December 2025" tags={["New releases"]} rss={{ title: "Advanced Reasoning Models & Multi-Provider Support", description: "Support for 50+ AI models across 9 providers with advanced reasoning capabilities" }}>
  ...
  Learn more about [reasoning models](/providers/reasoning-models) and [available models](/providers/overview).
...
<Update label="June 2023" tags={["New releases"]} rss={{ title: "Subscriber API Endpoint", description: "New endpoint to fetch all bot subscribers" }}>
  ...
  Refer to the [API reference](/api-reference/introduction).
...
<Update label="June 2023" tags={["New releases"]} rss={{ title: "Chat List Endpoint", description: "Fetch all chats in a bot" }}>
  ...
  Refer to the [API reference](/api-reference/endpoints/chat).
...
<Update label="May 2023" tags={["Improvements"]} rss={{ title: "Streaming Support", description: "Control response behavior with stream parameter" }}>
  ...
  Refer to the updated [API reference](/api-reference/endpoints/chat).
...
<Update label="May 2023" tags={["Improvements"]} rss={{ title: "Multiple File Links", description: "Support for multiple file links in bot training" }}>
  ...
  Refer to the [API reference](/api-reference/endpoints/training).
