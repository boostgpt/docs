...
When your agent runs in **Agent** reasoning mode, it has access to a powerful set of built-in tools. These tools let your agent search knowledge, manage files, browse the web, plan complex tasks, and more.
...
|-------|----------|---------|
| **Auto** | Executes immediately without asking | Search, Read, Think |
