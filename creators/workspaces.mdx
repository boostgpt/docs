...
Workspaces are automatically created when needed. **Each conversation gets its own
isolated workspace** — logged-in or anonymous, files stay private to that chat.
...
<Info>
Building a website? Sites get a visual editor and version history on top of the
file tools described here — see [Site Builder](/creators/site-builder).
</Info>
...
<CardGroup cols={2}>
  <Card title="Tasks" icon="list-check" href="/creators/tasks">
