...
<CardGroup cols={2}>  <Card title="SendGrid" icon="paper-plane" href="/integrations/connectors/sendgrid">
...
<CardGroup cols={2}>
  <Card title="Shopify" icon="shopify" href="/integrations/connectors/shopify">
    E-commerce platform
  </Card>  <Card title="Stripe" icon="stripe" href="/integrations/connectors/stripe">
    Payment processing
  </Card>
</CardGroup>
...
<CardGroup cols={2}>  <Card title="Mixpanel" icon="chart-bar" href="/integrations/connectors/mixpanel">
    Product analytics
  </Card>
</CardGroup>
