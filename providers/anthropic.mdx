...
<CardGroup cols={2}>
  ...
  <Card title="Claude Sonnet 5" icon="zap">
  ...
  <Card title="Claude Opus 4.7" icon="circle">
  ...
  <Card title="Claude Opus 4.6" icon="gauge">
  ...
  <Card title="Claude Haiku 4.5" icon="star">
  ...
  <Card title="Claude Opus 4.5" icon="brain">
  ...
  <Card title="Claude Sonnet 4.5" icon="wand-magic-sparkles">
