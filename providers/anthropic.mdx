...
<CardGroup cols={2}>
  <Card title="Claude Fable 5.1" icon="bolt">
  ...
  <Card title="Claude Fable 5" icon="bolt">
  ...
  <Card title="Claude Opus 5" icon="sparkles">
  ...
  <Card title="Claude Opus 4.8" icon="zap">
  ...
  <Card title="Claude Sonnet 5" icon="circle">
  ...
  <Card title="Claude Sonnet 4.6" icon="star">
  ...
  <Card title="Claude Haiku 4.5" icon="brain">
    **1 credit** • The fastest Claude model, with near-frontier intelligence for everyday tasks.
  ...
  <Card title="Claude Opus 4.5" icon="wand-magic-sparkles">
    **5 credits** • Previous-generation Claude Opus with superior reasoning and contextual understanding.
  ...
  <Card title="Claude Sonnet 4.5" icon="microchip">
    **3 credits** • Balanced Claude Sonnet model with solid performance across everyday tasks.
