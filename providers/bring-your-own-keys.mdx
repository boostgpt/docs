...
<AccordionGroup>
  ...
  <Accordion icon="question" title="How secure is storing my API key in BoostGPT?">
    API keys are encrypted at rest and in transit. Only your agents use your keys, never shared with other users. See [Security Best Practices](#security-best-practices) above for details.
  </Accordion>
</AccordionGroup>
