...
<CardGroup cols={2}>
  ...
  <Card title="Gemini 3.5 Flash Lite" icon="zap">
  ...
  <Card title="Gemini 3.1 Flash Lite" icon="circle">
  ...
  <Card title="Gemini 3.1 Pro" icon="gauge">
  ...
  <Card title="Gemini 2.5 Pro" icon="star">
  ...
  <Card title="Gemini 2.5 Flash Lite" icon="wand-magic-sparkles">
