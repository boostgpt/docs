...
<CardGroup cols={2}>
  <Card title="MiniMax M2.7 Highspeed" icon="bolt">
  ...
  <Card title="MiniMax M2.5 Highspeed" icon="sparkles">
  ...
  <Card title="MiniMax M3" icon="zap">
  ...
  <Card title="MiniMax M2.7" icon="circle">
  ...
  <Card title="MiniMax M2.5" icon="gauge">
