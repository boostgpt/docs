...
<CardGroup cols={2}>
  <Card title="Mistral Small" icon="bolt">
    **1 credit** • Efficient model for basic tasks. Good balance of speed and capability.
  ...
  <Card title="Mistral Medium" icon="sparkles">
    **2 credits** • Mid-tier model with enhanced capabilities. Suitable for more complex tasks.
  ...
  <Card title="Mistral Large" icon="zap">
    **3 credits** • Most powerful Mistral model. Excellent for demanding applications and complex reasoning.
