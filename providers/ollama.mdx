...
| Model | Credits | Context | Speed | Hardware Needs | Best Use Case |
|-------|---------|---------|-------|----------------|---------------|
| **Llama 3.3 (70B)** | 2 | 128K | Medium | 40GB+ VRAM | Local power |
| **Llama 3.1 (405B)** | 4 | 128K | Slow | 200GB+ VRAM | Maximum local capability |
| **Llama 3.1 (70B)** | 2 | 128K | Medium | 40GB+ VRAM | Balanced local |
| **Llama 3.1 (8B)** | 1 | 128K | Fast | 8GB+ VRAM | Efficient local |

<Info>
  **Ollama's Strength**: Full data privacy, no API costs, complete control over your AI infrastructure. Run models entirely on your own hardware.
</Info>
...
<AccordionGroup>
  <Accordion icon="shield" title="Complete Data Privacy">
    All data stays on your infrastructure. No information leaves your network. Perfect for sensitive applications, healthcare, finance, or proprietary data.
  </Accordion>

  <Accordion icon="dollar-sign" title="No API Costs">
    After initial hardware investment, inference is free. No per-request charges, no rate limits, no monthly bills.
  </Accordion>

  <Accordion icon="sliders" title="Full Control">
    Customize models, control versions, modify parameters, and optimize for your specific use case. Complete flexibility.
  </Accordion>

  <Accordion icon="wifi-slash" title="Offline Operation">
    Works completely offline. No internet dependency for inference. Perfect for air-gapped environments or unreliable connectivity.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion icon="circle-exclamation" title="Connection refused">
  ...
  <Accordion icon="circle-exclamation" title="Model not found">
  ...
  <Accordion icon="circle-exclamation" title="Out of memory errors">
