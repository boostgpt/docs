...
<CardGroup cols={2}>
  <Card title="Llama 3.3 (70B) Local" icon="bolt">
    **1 credit** • Local 70B Llama model. Powerful performance for self-hosted deployments.

    - 128K context window
    - Excellent reasoning
    - Speed: Medium • Cost: Very_low
    - Model id: `llama3.3:70b`
  </Card>

  <Card title="Llama 3.1 (8B) Local" icon="sparkles">
    **1 credit** • Efficient local 8B model. Good for basic tasks with local processing.
  ...
  <Card title="Llama 3.1 (70B) Local" icon="zap">
    **1 credit** • Local 70B model. Strong performance for self-hosted applications.
  ...
  <Card title="Llama 3.1 (405B) Local" icon="circle">
    **2 credits** • Massive local model. Exceptional capabilities for self-hosted solutions.

    - 128K context window
    - Exceptional reasoning
    - Speed: Slow • Cost: Very_low
