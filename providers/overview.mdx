...
BoostGPT supports **14 AI providers** with **99 models** spanning from ultra-fast nano models to advanced reasoning models. Thirteen are hosted for you; Ollama runs on your own machine.

<CardGroup cols={2}>
  <Card title="OpenAI" icon="/images/providers/openai.svg" href="/providers/openai">
    15 models — GPT-6 Astra, GPT-6 Sol, GPT-6 Luna and more
  </Card>
  ...
  <Card title="Anthropic" icon="/images/providers/anthropic.svg" href="/providers/anthropic">
    12 models — Claude Fable 5.1, Claude Opus 5.5, Claude Fable 5 and more
  </Card>
  <Card title="xAI" icon="/images/providers/xai.svg" href="/providers/xai">
    7 models — Grok 4.7, Grok 4.6, Grok 4.5 and more
  </Card>
...
const bot = await client.createBot({
  ...
  // model: 'gpt-5.4', // Advanced reasoning
});
```
...
<CardGroup cols={2}>
  ...
  <Card title="Use Our Infrastructure" icon="cloud" href="/api-reference/authentication">
