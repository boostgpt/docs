...
<CardGroup cols={2}>
  ...
  <Card title="O3" icon="rocket">
    **6 credits** • Reasoning model for hard maths, science, coding and visual reasoning tasks.
  ...
  <Card title="O4 Mini" icon="zap">
    **3 credits** • Small o-series model optimised for fast, effective reasoning.
  ...
  <Card title="O3 Mini" icon="microchip">
...
<CardGroup cols={2}>
  ...
  <Card title="Gemini 2.5 Pro" icon="circle">
