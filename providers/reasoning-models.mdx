...
<CardGroup cols={2}>
  <Card title="GPT-6 Astra" icon="rocket">
  ...
  <Card title="GPT-6 Sol" icon="brain">
    **3 credits** • GPT-6 reasoning at half the cost of GPT-5.6 Sol, for coding and complex professional work.
  ...
  <Card title="GPT-6 Luna" icon="zap">
    **1 credit** • The fastest, most affordable GPT-6 model, for high-volume tasks with a clear goal.
  ...
  <Card title="GPT-5.6 Sol" icon="brain">
    **6 credits** • Previous-generation frontier model, built for complex professional work requiring deep reasoning.
  ...
  <Card title="GPT-5.6 Terra" icon="bolt">
    **3 credits** • Previous-generation balanced tier offering strong reasoning and multimodal input at moderate cost.
  ...
  <Card title="GPT-5.6 Luna" icon="sparkles">
    **1 credit** • Previous-generation cost-efficient tier, designed for high-volume, cost-sensitive workloads.
  ...
  <Card title="GPT-5.4 Mini" icon="bolt">
  ...
  <Card title="GPT-5.4 Nano" icon="sparkles">
  ...
  <Card title="GPT-5 Mini" icon="gauge">
  ...
  <Card title="GPT-5 Nano" icon="star">
...
<CardGroup cols={2}>
  <Card title="Gemini 3.7 Flash" icon="brain">
  ...
  <Card title="Gemini 3.6 Flash" icon="bolt">
  ...
  <Card title="Gemini 3.5 Flash" icon="sparkles">
  ...
  <Card title="Gemini 3.5 Flash Lite" icon="gauge">
  ...
  <Card title="Gemini 3.1 Flash Lite" icon="star">
  ...
  <Card title="Gemini 2.5 Flash" icon="microchip">
  ...
  <Card title="Gemini 2.5 Flash Lite" icon="cube">
...
<CardGroup cols={2}>
  <Card title="Claude Fable 5.1" icon="rocket">
    **10 credits** • Anthropic's most capable model, with cheaper cache reads than Fable 5 for long agentic work.
  ...
  <Card title="Claude Opus 5.5" icon="sparkles">
    **4 credits** • Anthropic's recommended model for most work: long-running agentic coding and knowledge work, near Fable 5.1 at a lower cost.
  ...
  <Card title="Claude Opus 5" icon="bolt">
    **5 credits** • Previous-generation Opus model for complex agentic coding and enterprise work, with a 1M-token context window.
  ...
  <Card title="Claude Opus 4.8" icon="sparkles">
  ...
  <Card title="Claude Sonnet 5" icon="gauge">
  ...
  <Card title="Claude Opus 4.6" icon="rocket">
  ...
  <Card title="Claude Sonnet 4.6" icon="zap">
...
<CardGroup cols={2}>
  <Card title="Grok 4.7" icon="rocket">
    **1 credit** • xAI's most capable model for coding and knowledge work, with a 500K context window.
  ...
  <Card title="Grok 4.6" icon="brain">
    **1 credit** • Previous-generation Grok model, with a 500K context window and strong multimodal reasoning.
  ...
  <Card title="Grok 4.3" icon="sparkles">
  ...
  <Card title="Grok 4.20 Reasoning" icon="gauge">
...
<CardGroup cols={2}>
  ...
  <Card title="GLM-5.3 Flash" icon="bolt">
...
<CardGroup cols={2}>
  <Card title="MiniMax M2.7 Highspeed" icon="brain">
  ...
  <Card title="MiniMax M2.5 Highspeed" icon="bolt">
  ...
  <Card title="MiniMax M3" icon="sparkles">
  ...
  <Card title="MiniMax M2.7" icon="gauge">
  ...
  <Card title="MiniMax M2.5" icon="star">
...
<CardGroup cols={2}>
  ...
  <Card title="DeepSeek V4 Flash Vision" icon="bolt">
  ...
  <Card title="DeepSeek V4 Pro" icon="sparkles">
